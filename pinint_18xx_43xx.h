 ...
 */
STATIC INLINE void Chip_PININT_Init(LPC_PIN_INT_T *pPININT __attribute__((__unused__))) {}
 ...
 * @return	Nothing
 */
STATIC INLINE void Chip_PININT_DeInit(LPC_PIN_INT_T *pPININT __attribute__((__unused__))) {}
