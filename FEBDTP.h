...
#ifndef INC_FEBDTP_H_
#define INC_FEBDTP_H_
...
#define FEB_SET_FPGA_CFG 0x0106
...
typedef struct {
	...
	uint16_t  iptype;	        /*!< IP protocol type*/
//	uint8_t   IG;	/*!< LLC IG byte = 00*/
//	uint8_t   CR;	/*!< LLC CR  byte = 01*/
//	uint16_t  CF;	/*!< LLC Control field = 02 03*/
	uint16_t  CMD;	/*!< FEBDTP command field*/
	uint16_t  REG;	/*!< FEBDTP register field*/
	uint8_t   Data[MAXPAYLOAD]; /*!< FEBDTP data field, */

} FEBDTP_PKT; // packet total length 1500 bytes
